...
<header 
    class="fixed z-navBar transition-transform md:relative w-full md:h-full h-screen -translate-x-full md:translate-x-0 md:col-span-3 bg-daisyBush text-center" 
