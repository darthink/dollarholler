...
<div class="invoice-line-item">
	...
	<div class="relative">
		<input
			class="line-item h-10 w-full border-b-2 border-dashed border-stone-300 pr-4 text-right focus:border-solid focus:border-lavendarIndigo focus:outline-none"
			type="number"
			name="discount"
			min="0"
			max="100"
